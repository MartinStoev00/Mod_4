...
<html>
    ...
    <body>
        ...
        <div class="title_content">
            <header class="root_header" style="margin-top: 75px; margin-bottom: 25px;">
                Settings
            </header>
        </div>
        ...
        <div class="body_wrapper">
            ...
            <div class="welcome" id="welcome" style="text-align: right; font-size: 2.5vh;">Welcome: Loading...</div>
            <div class="panel">
                <div class="settings_card">
                    ...
                    <form action="changesettings">
                        <div class="settings_wrapper" style="height: 30vh;">
    
                            <div class="setting_field">
                                <div class="setting_label">
                                    First Name:
                                </div>
                                <input name="first_name" class="setting_text_input" id="first_name_input" type="text" placeholder="Loading..." style="background-image: url('icons/user.png'); background-position: 7px 3px; background-repeat: no-repeat; background-size: 2vh;">
                            </div>
                            ...
                            <div class="setting_field">
                                ...
                                <input name="last_name" class="setting_text_input" id="last_name_input" type="text" placeholder="Loading..." style="background-image: url('icons/user.png'); background-position: 7px 3px; background-repeat: no-repeat; background-size: 2vh;">
                            </div>
                            ...
                            <div class="setting_field">
                                ...
                                <input name="email" class="setting_text_input" id="email_input" type="text" placeholder="Loading..." style="background-image: url('icons/mail.png'); background-position: 5px 1px; background-repeat: no-repeat; background-size: 2vh;">
                            </div>
                            ...
                            <div class="setting_field">
                                ...
                                <input name="password" class="setting_text_input"  id="password_input" type="password" placeholder="********" style="background-image: url('icons/lock.png'); background-position: 7px 3px; background-repeat: no-repeat; background-size: 2vh;"">
                            </div>
                            ...
                            <div class="setting_field">
                                ...
                                <input name="old_password" class="setting_text_input"  id="old_password_input" type="password" placeholder="********" style="background-image: url('icons/lock.png'); background-position: 7px 3px; background-repeat: no-repeat; background-size: 2vh;"">
                            </div>
    
                            <div class="settings_note" style="margin-top: 2vh;">
                        ...
                        <div class="settings_wrapper" style="height: 10vh;">
